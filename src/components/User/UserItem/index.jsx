        ...
        <div className="card text-center">
          {user && !isEditing ? (
            ...
            <>
              ...
              {validate.name ? (
                <p className="bg-danger p-2 text-danger bg-opacity-25">
                  You need enter to Name
                </p>
              ) : null}
            </>
          )}
          ...
          <div className="card-body">
            {user && !isEditing ? (
              ...
              <>
                ...
                {validate.position ? (
                  <p className="bg-danger p-2 text-danger bg-opacity-25">
                    You need enter to Position
                  </p>
                ) : null}
              </>
            )}
            <Link to="/schedule" className="btn btn-primary m-2">
              Schedule
            </Link>
          </div>
          <div className="card-footer flex-center">
            {user ? (
              <>
                ...
                >
                  <ion-icon class="btn-icon" name="close-outline"></ion-icon>
                  Remove
                </button>
              </>
            ) : (
