  ...
  return (
    <div>
      ...
      <div>
        <nav>
          <div
            className="nav nav-tabs justify-flex-end"
            id="nav-tab"
            role="tablist"
          >
            <button
              ...
              <Table responsive>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      {moment(schedule.time_start).format(
                        "DD/MM/yyyy HH:mm:ss"
                      )}
                    </td>
                    <td>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSchedule({ ...schedule, creator: e.target.value })
                  }
                  required
                />
              </div>
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSchedule({ ...schedule, time_start: e.target.value })
                  }
                  required
                />
              </div>
